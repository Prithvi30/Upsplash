...
public final class UnsplashClient {
    ...
    public init(locations: URL = URL(string: "https://api.unsplash.com/")!,
    ...
    public func execute<A>(resource: Resource<A>,
        ...
        let components: URLComponents = URLComponents(url: (location ?? nil)!,
...
public extension UnsplashClient {
    ...
    convenience public init(location: URL = URL(string: "https://api.unsplash.com/")!,
                            session: URLSession = URLSession.shared,
                            headersProvider: HeadersProvider) {
        self.init(locations: location, session: session, headers: headersProvider.headers)
    }
